...
var argv = require('minimist')(process.argv.slice(2), {
    string: ['url', 'pdf', 'chrome-binary', 'chrome-option', 'remote-host', 'remote-port', 'window-size', 'paper-width', 'paper-height', 'page-ranges', 'scale', 'header-template', 'footer-template', 'js-time-budget', 'animation-time-budget'],
...
var animationTimeBudget = void 0;
            ...
            switch (_context.prev = _context.next) {
                case 0:
                    ...
                    return RenderPDF.generateMultiplePdf(jobs, {
                        ...
                        jsTimeBudget: jsTimeBudget,
                        animationTimeBudget: animationTimeBudget
                    });
