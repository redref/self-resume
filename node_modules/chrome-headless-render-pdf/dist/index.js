    ...
    (0, _createClass3.default)(RenderPDF, [{
                ...
                return _regenerator2.default.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            ...
                            case 13:
                                _context4.next = 15;
                                return Emulation.setVirtualTimePolicy({ policy: 'pauseIfNetworkFetchesPending', budget: this.options.jsTimeBudget });
                                        ...
                                        while (1) {
                                            switch (_context3.prev = _context3.next) {
                                                case 0:
                                                    _context3.next = 2;
                                                    return new _promise2.default(function (resolve) {
                                                        setTimeout(resolve, _this2.options.animationTimeBudget); // max waiting time
                    ...
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            ...
                            case 9:
                                ...
                                commandLineOptions = ['--headless', '--remote-debugging-port=' + this.port, '--disable-gpu'].concat((0, _toConsumableArray3.default)(this.options.chromeOptions), ['about:blank']);
        ...
        value: function () {
            var _ref11 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee11() {
                var v4Host, v6Host, v6, v4, ok, _ok;
                    ...
                    while (1) {
                        switch (_context11.prev = _context11.next) {
                            ...
                            case 6:
                                v4Host = "127.0.0.1";
                                v6Host = "::1";
                                v6 = this.isPortOpen(v6Host, this.port);
                                v4 = this.isPortOpen(v4Host, this.port);
                                _context11.prev = 10;
                                _context11.next = 13;
                                return v6;
                            ...
                            case 24:
                                ...
                                this.host = v4Host;
                                return _context11.abrupt('return', _ok);
                ...
                }, _callee11, this, [[10, 19], [21, 30]]);
            }));

            function detectOpenPort() {
                return _ref11.apply(this, arguments);
            }

            return detectOpenPort;
        }()
    }, {
        ...
        key: 'isPortOpen',
        value: function () {
            var _ref14 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee14(host, port) {
        ...
        key: 'wait',
        value: function () {
            var _ref15 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee15(ms) {
        ...
        value: function () {
            var _ref16 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee16(url, filename, options) {
                var renderer, buff;
        ...
        value: function () {
            var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee17(url, options) {
                var renderer;
        ...
        value: function () {
            var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee18(pairs, options) {
                ...
                }, _callee18, this, [[6, 26, 30, 38], [10, 18], [31,, 33, 37]]);
            }));
